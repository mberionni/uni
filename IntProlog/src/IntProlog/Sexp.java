...
public abstract class Sexp
{
	...
	public static Sexp qfalse = new IdentSexp("false");
	...
	/*
	 * operazioni abstract che devono essere realizzate dalle sottoclassi
	 */
	...
	/*
	 * public static Sexp coppia( Sexp t1, Sexp t2 ) { return new CoppiaSexp(
	 * t1,t2 ); }
	 */
	...
	/*
	 * public static Sexp number( int v ) {return new IntSexp( new Integer(v) );
	 * }
	 */
	...
	public static Sexp list10(Sexp t1, Sexp t2, Sexp t3, Sexp t4, Sexp t5,
			Sexp t6, Sexp t7, Sexp t8, Sexp t9, Sexp t10)
	{
		return Sexp.append(list5(t1, t2, t3, t4, t5),
				list5(t6, t7, t8, t9, t10));
	}

	public static Sexp list15(Sexp t1, Sexp t2, Sexp t3, Sexp t4, Sexp t5,
			Sexp t6, Sexp t7, Sexp t8, Sexp t9, Sexp t10, Sexp t11, Sexp t12,
			Sexp t13, Sexp t14, Sexp t15)
	{
		return Sexp.append(list10(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10),
				list5(t11, t12, t13, t14, t15));
	}
	...
	{
		return (isNull(vars)) ? a : cons(cons(car(vars), car(vals)),
	...
	{
		return (isNull(plis)) ? nil : (isEq(caar(plis), el)) ? car(plis)
				: assoc(el, cdr(plis));
		/*
		 * if( isNull( plis ) ) return nil; else
	...
	public static boolean isPresent(IdentSexp x, Sexp l1) // funzione
															// attualmente non
															// usata
	...
	{
		return operatorSetNames();
	}

	public static Sexp operatorSetNames()
	{
		return list15(atom("+"), atom("-"), atom("*"), atom("/"), atom("<"),
				atom(">"), atom("="), atom("eq"), atom("car"), atom("cdr"),
				atom("cons"), atom("eval"), atom("not"), atom("and"),
				atom("or"));
	}

	public static Sexp createPrimitiveSet(Sexp pNameList)
	{
		return (pNameList.isEq(nil)) ? nil : cons(
				cons(qprimitive, pNameList.car()),
				createPrimitiveSet(pNameList.cdr()));
	}

	public static boolean selfEvaluating(Sexp e)
	{
		if (e instanceof AtomSexp) return (e.isEq(qtrue) || e.isEq(qfalse)
