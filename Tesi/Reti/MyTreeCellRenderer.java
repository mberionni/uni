...
{   private final ImageIcon rootIcon = ConfigDataAccessClient.rootIcon;
    ...
    private final ImageIcon attributeIcon = ConfigDataAccessClient.attributeIcon;
    ...
    protected final int attributeType = ConfigDataAccessClient.attributeType;
    ...
    {     if (value instanceof DefaultMutableTreeNode)
          {   DefaultMutableTreeNode node = (DefaultMutableTreeNode)value;
              ...
              if (nodeUserObject instanceof OggettoNodo)
              {   OggettoNodo userObject = (OggettoNodo)nodeUserObject;
                  ...
                  {   switch ( userObject.getTipoNumerico() )
                      {   case moduleType:                  myRenderer.setOpenIcon(moduleIcon);
                                                            myRenderer.setClosedIcon(moduleIcon);
                                                            myRenderer.setLeafIcon(moduleIcon);
                                                            break;
                          case interfaceType:               myRenderer.setOpenIcon(interfaceIcon);
                                                            myRenderer.setClosedIcon(interfaceIcon);
                                                            myRenderer.setClosedIcon(interfaceIcon);
                                                            break;
                          case operationType:               myRenderer.setOpenIcon(operationIcon);
                          ...
                          case arrayType:                   myRenderer.setOpenIcon(typedefIcon);
                                                            ...
                                                            myRenderer.setLeafIcon(typedefIcon);
                                                            break;
                          case attributeType:               myRenderer.setOpenIcon(attributeIcon);
                                                            myRenderer.setClosedIcon(attributeIcon);
                                                            myRenderer.setLeafIcon(attributeIcon);
                                                            break;
                  ...
                  }   catch (Exception e) {   System.out.println("eccezione in myTreeCellRenderer poichè selezionato nodo inesistente");
                                          }
