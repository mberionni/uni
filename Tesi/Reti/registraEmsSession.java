...
{ protected static final String[] idRep =  new String[] { "IDL:mtnm.tmforum.org/emsSession:1.0" };
  ...
  {     org.omg.CORBA.InterfaceDef[] base_interfaces = { };
        ...
        try { //Repository ir = RepositoryHelper.narrow(orb.resolve_initial_references("InterfaceRepository"));
              ...
              ModuleDef emsSession = ir.create_module(idRep[0],"emsSession","1.0");
              ...
              controlla(c);
              org.omg.CORBA.InterfaceDef[] bas = { session, session };
              ...
              //FullInterfaceDescription d = emsSession_I.describe_interface();
              //println("lenght = " + d.base_interfaces.length);
              //println("el[0] = " + d.base_interfaces[0]);
              println("lenght = " + emsSession_I.base_interfaces().length );
              println("base int2 = " + bas[0].absolute_name());
              println("el[0] = " + emsSession_I.base_interfaces()[0].absolute_name());
              println("- creata interfaccia con id = " + ident + " base interfaces");
