...
public abstract class PFPrintObject {
   ...
   public void computePositionAndSize () {
      ...
      switch (verticalSticky) {
         ...
         case STICKY_BOTTOM:
            ...
            drawOrigin.setLocation (drawOrigin.getX (),
                                    objectPosition.add (drawOrigin.getY ()));
            break;
      }
      ...
      switch (horizontalSticky) {
         ...
         case STICKY_CENTER:
            ...
            objectPosition = (PFInchUnit) parentCenter.substract (childCenter);
            drawOrigin.setLocation (objectPosition.add (drawOrigin.getX ()),
                                    drawOrigin.getY ());
            break;
    ...
    *
    * @param parSticky a value of type int
    */
    ...
    *
    * @param parFill a value of type boolean
    */
    ...
    *
    * @param parPosition a value of type PFPoint
    */
    ...
    *
    * @param parMode a value of type boolean
    */
