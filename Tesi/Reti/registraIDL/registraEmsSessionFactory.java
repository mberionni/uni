...
{ public static final String[] idRep =  new String[] { "IDL:mtnm.tmforum.org/emsSessionFactory:1.0" };
  ...
  {     org.omg.CORBA.InterfaceDef[] base_interfaces = { };
        try { ModuleDef emsSessionFactory = ir.create_module(idRep[0],"emsSessionFactory","1.0");
              ...
              c = ir.lookup_id("IDL:mtnm.tmforum.org/mtnmVersion/Version_I:1.0");
              controlla(c);
              InterfaceDef Version_I = InterfaceDefHelper.narrow(c);
              TypeCode tcv = orb.create_interface_tc("IDL:mtnm.tmforum.org/mtnmVersion/Version_I:1.0", "Version_I");
