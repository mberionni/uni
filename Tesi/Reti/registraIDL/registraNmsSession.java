...
{ public static final String[] idRep =  new String[] { "IDL:mtnm.tmforum.org/nmsSession:1.0" };
  ...
  {  RegistrationClass rC = new RegistrationClass();
     ...
     regNmsSession.registrazioneRepository();
  ...
  {     org.omg.CORBA.InterfaceDef[] base_interfaces = { };
        ...
        try { ModuleDef nmsSession = ir.create_module(idRep[0],"nmsSession","1.0");
              ...
              nmsSession_I.create_operation(ident, "eventLossOccurred", nmsSession_I.version(),
                                            tipoVoid,
                                            OperationMode.OP_NORMAL,
                                            parametri,
                                            eccezioni,
