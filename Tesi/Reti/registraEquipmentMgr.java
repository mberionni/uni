...
public class registraEquipmentMgr extends RegistrationClass
{ public static final String[] idRep =  new String[] { "IDL:mtnm.tmforum.org/equipment:1.0" };
  private static String interfaceVersion = "1.0";

  public registraEquipmentMgr()
  {  println("@ - avvio registrazione modulo equipment inventory Manager");
     registrazioneRepository();
     println("@ - fine registrazione equipment inventory manager");
  }
  ...
  {   try {   //Repository ir = RepositoryHelper.narrow(orb.resolve_initial_references("InterfaceRepository"));
              ...
              ModuleDef Eqm = ir.create_module(idRep[0], "equipment", "1.0");
              ...
              StructMember[] sms =  new StructMember[] { sm1, sm2, sm3, sm4, sm5, sm6, sm7, sm8, sm9, sm10, sm11  };
              ...
              //TypeCode EquipmentOrHolder_TTypeCode = orb.create_union_tc(ident, "EquipmentOrHolder_T", EquipmentTypeQualifier_T.type(), union);
              ...
              //TypeCode EquipmentOrHolder_TSequenceTypeCode = orb.create_sequence_tc(10, EquipmentOrHolder_TTypeCode);

              //TypeCode EquipmentOrHolderList_TTypeCode = orb.create_alias_tc(ident, "EquipmentOrHolderList_T", EquipmentOrHolder_TTypeCode);
              ...
              //  IDLType tipoInt = InterfaceDefHelper.narrow(equipment.EquipmentOrHolderIterator_I);
